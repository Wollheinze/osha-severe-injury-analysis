...
* `osha_severe_injuries_2015_2025.csv` — source data
...
Download the `.pbix` file and open it with Power BI Desktop. If you want to refresh the data, update the CSV source path in Power Query.
